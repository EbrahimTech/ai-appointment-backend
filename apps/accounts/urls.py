...
from apps.accounts.views import (
    ...
    ClinicPatientAIToggleView,
    ClinicServiceAdminView,
    ClinicSettingsView,
    ClinicSetupStatusView,
...
urlpatterns = [
    ...
    path(
        "clinic/<slug:slug>/patients/<int:patient_id>",
        ClinicPatientDetailView.as_view(),
        name="clinic-patient-detail",
    ),
    path(
        "clinic/<slug:slug>/patients/<int:patient_id>/ai",
        ClinicPatientAIToggleView.as_view(),
        name="clinic-patient-ai",
    ),
    ...
    path(
        ...
        ClinicSetupStatusView.as_view(),
        name="clinic-setup-status",
    ),
    path(
        "clinic/<slug:slug>/settings",
        ClinicSettingsView.as_view(),
